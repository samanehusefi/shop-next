            ...
            <div className="flex gap-2.5 sm:gap-3">
              {activeProducts.map((product) => {
                ...
                return (
                  <Link
                    key={product.id}
                    href={`/product/d/${product.id}/${slug}`}
                    className="group flex h-[280px] w-[155px] min-w-[155px] shrink-0 flex-col overflow-hidden rounded-lg border border-gray-200 bg-white transition hover:shadow-sm sm:h-[330px] sm:w-[180px] sm:min-w-[180px] md:h-[340px] md:w-[205px] md:min-w-[205px]"
                  >
