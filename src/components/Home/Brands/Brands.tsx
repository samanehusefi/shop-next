            ...
            <div className="flex gap-2 sm:gap-3">
              {visibleBrands.map((brand) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-[116px] w-[84px] min-w-[84px] shrink-0 flex-col overflow-hidden rounded-lg border border-gray-200 bg-white transition hover:shadow-sm sm:h-[125px] sm:w-[92px] sm:min-w-[92px]"
                >
