...
const SearchAddress = ({ onSelect }: SearchAddressProps) => {
  ...
  return (
    <div className="absolute right-4 top-4 z-[1000] w-[70%] p-3">
      <div className="relative">
        <input
          ...
          className="h-12 w-[70%] rounded-xl border border-gray-200 bg-white px-4 pr-12 text-right text-sm text-gray-700 shadow-lg outline-none placeholder:text-gray-400 focus:border-orange-400"
        />
      ...
      {results.length > 0 && (
        <div className="mt-2 max-h-72 overflow-y-auto rounded-xl border border-gray-100 bg-white p-4 shadow-lg">
