        ...
        {megaMenu.map((menu) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-h-[60px] w-full items-center gap-2 border-b border-gray-200 px-2 py-3 text-right ${
                isActive
            ...
            >
              {isActive && (
                <span className="absolute bottom-2 right-0 top-2 w-1 rounded-l-full bg-red-500" />
              )}
